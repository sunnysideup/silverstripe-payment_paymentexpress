...
{
    public static $pxAccess_Url = "https://sec.paymentexpress.com/pxpay/pxpay.aspx";
    ...
    public static function set_use_iframe($use = true)
    {
        self::$use_iframe = $use;
    }
...
{
    public static $URLSegment = 'paymentexpressctl';
